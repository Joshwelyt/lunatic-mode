...
const ulopersGenerator = extend(PlanetGenerator, {
    rawHeight(position){
...
ulopersGenerator.rid = new Packages.arc.util.noise.RidgedPerlin(1, 2);
ulopersGenerator.basegen = new BaseGenerator();
ulopersGenerator.scl = 5;
ulopersGenerator.waterOffset = 0.07;
ulopersGenerator.water = 2 / ulopersGenerator.arr[0].length;
