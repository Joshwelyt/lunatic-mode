//no more auto connect for you
function insulate(block){
    Blocks[block].insulated=true;
}
var blockArray=["copperWall","copperWallLarge","titaniumWall","titaniumWallLarge",
...
"foreshadow","overdriveDome","commandCenter",
"repairPoint",
"message","powerSource","powerVoid","itemSource","itemVoid","liquidSource","liquidVoid","message","illuminator"];
